...
from square_3d import create_nodes, create_elements
...
if __name__ == '__main__':
    ...
    for point_index in mesh.boundary_points:
        ...
        elif p[0] == x_min and p[1] == y_min and p[2] == z_min:
    ...
    for ch_idx, edge_points in enumerate(mesh.convex_hull):
        ...
        if p1[0] == x_min and p2[0] == x_min and p1[1] == y_min and p2[1] == y_min and p1[2] == z_min and p2[2] == z_min:
            pass
        else:
    ...
    ax.quiver(x[::5], y[::5], u_norm[::5], v_norm[::5], units='xy', scale=20, alpha=0.5)
    ...
    plt.savefig('output/NS_3D_ex003.png')
    plt.close()